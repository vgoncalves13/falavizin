...
| B002 | Dependências | ✅ Corrigir advisories Composer e npm bloqueadores — concluída em 20/07/2026 | Atualizar versões compatíveis e revisar transitivas | segurança | P0 | M | — | 0 | audits zerados; 182 testes e build verdes |
