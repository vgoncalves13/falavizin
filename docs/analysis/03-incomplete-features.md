...
| Notificações | Banco, sino e lista existem; B012 mantém database síncrono e enfileira e-mail/reset após commit com timeout e backoff | Preferências, templates consistentes, política de entrega e alerta do worker | S–M | **Manter base atual** e evoluir após operação real |
