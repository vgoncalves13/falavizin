...
| Centralizar regras duplicadas restantes | Actions únicas para escrita de negócio/promoção; remover drift HTTP/Livewire | Decisão sobre UI canônica | P1 / L | Refactor amplo | Mesma validação/persistência em qualquer entrada e testes compartilhados | Menos código e bugs |
