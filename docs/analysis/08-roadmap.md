...
| ✅ Corrigir vulnerabilidades conhecidas — concluído em 20/07/2026 | Atualizar locks dentro de versões compatíveis; revisar Laravel/Symfony/Guzzle/Axios/Vite/transitivas | Backup/branch e suíte atual verde | P0 / M | Regressões de patch | Audits zerados; 183 testes e build passam | Base atualizável e segura |
| Fechar exposição pública e XSS — XSS concluído na B003 | Restringir status e construir popups sem HTML inseguro | Testes de status e payload malicioso | P0 / S | Bloquear autor/admin indevidamente | Popup já é texto inerte; falta impedir visitante em não aprovados | Conteúdo moderado protegido |
