...
| Baseline de engenharia restante | README, CI, formatter, audit, worker/scheduler/backup | Decisões de deploy | P1 / M | Divergência local/CI | Setup limpo reproduz testes/build; CI verde; runbook testado | Desenvolvimento reproduzível |
