...
| Consolidar cache | Remover queries da view e centralizar chaves/invalidação | Métricas/query plan | P1 / M | Conteúdo obsoleto | Zero queries em Blade e cache invalidado por mutação | Escala básica restante |
